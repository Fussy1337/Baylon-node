...
Делигировать себя можно получая 0.1 токен с одного дискора на 1  кошелек и далее отправляя на основоной кошелек по 0.1 токену после получения командой ( по русски берем 1 дискорд создаем еще кош в ноде, получаем 0.1 токен раз в сутки и далее комнадой ниже отправляем на меин, после чегго комнадой выше деллигируем себя уже не на 0.1 токена в сутки а на 1 допустим, отправляя с 10 дс на 10 кошей по 0.1 токену а далее делигируя себя с меина)
